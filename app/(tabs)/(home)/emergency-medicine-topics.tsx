...
export default function EmergencyMedicineTopicsScreen() {
  ...
  useEffect(() => {
    console.log('EmergencyMedicineTopicsScreen rendered, updateTrigger:', updateTrigger);
  ...
  const handleTopicPress = (topicName: string) => {
    ...
    console.log('Navigating to Emergency Medicine topic:', topicName);
    router.push({
      pathname: '/(tabs)/(home)/flashcards',
      params: { topic: topicName, system: 'Emergency Medicine & Trauma' }
    });
  };
    ...
    <>
      ...
      <ScrollView style={commonStyles.container} contentContainerStyle={styles.content}>
        ...
        <View style={styles.header}>
          <IconSymbol name="cross.case.fill" size={48} color={colors.error} />
          <Text style={styles.headerTitle}>Emergency Medicine & Trauma</Text>
        ...
        <View style={styles.section}>
          {EMERGENCY_MEDICINE_TOPICS.map((topic, index) => {
            const stats = getTopicStats('Emergency Medicine & Trauma', topic.name);
          ...
          <Pressable style={styles.referenceCard} onPress={handleReferencesPress}>
            <View style={styles.referenceContent}>
              ...
              <View style={styles.referenceInfo}>
                <Text style={styles.referenceTitle}>Emergency Medicine References</Text>
          ...
          <Pressable style={styles.referenceCard} onPress={handleGuidelineWebsitesPress}>
            <View style={styles.referenceContent}>
              ...
              <View style={styles.referenceInfo}>
                ...
                <Text style={styles.referenceDescription}>
                  Official emergency medicine resources and guidelines
                </Text>
              </View>
              <IconSymbol name="chevron.right" size={20} color={colors.textSecondary} />
            </View>
