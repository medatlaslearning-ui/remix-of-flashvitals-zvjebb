...
import { renalReferences, getSubcategories } from '@/data/renalReferences';

export default function RenalReferencesScreen() {
  ...
  const subcategories = getSubcategories('Renal References');

  return (
    <>
      <Stack.Screen
        options={{
          title: 'Renal References',
      ...
      <ScrollView style={commonStyles.container} contentContainerStyle={styles.content}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Renal References</Text>
        ...
        {subcategories.map((subcategory, subIndex) => {
          const refs = renalReferences.filter(
            ref => ref.category === 'Renal References' && ref.subcategory === subcategory
          );
