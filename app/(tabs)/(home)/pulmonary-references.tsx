...
import { pulmonaryReferences, getSubcategories } from '@/data/pulmonaryReferences';

export default function PulmonaryReferencesScreen() {
  ...
  const subcategories = getSubcategories('Pulmonary References');

  return (
    <>
      <Stack.Screen
        options={{
          title: 'Pulmonary References',
      ...
      <ScrollView style={commonStyles.container} contentContainerStyle={styles.content}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Pulmonary References</Text>
        ...
        {subcategories.map((subcategory, subIndex) => {
          const refs = pulmonaryReferences.filter(
            ref => ref.category === 'Pulmonary References' && ref.subcategory === subcategory
          );
