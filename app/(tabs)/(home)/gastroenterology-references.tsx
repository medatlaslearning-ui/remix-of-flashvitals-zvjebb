...
import { academicReferences } from '@/data/gastroenterologyReferences';

export default function GastroenterologyReferencesScreen() {
  ...
  return (
    <>
      <Stack.Screen
        options={{
          title: 'Gastroenterology References',
      ...
      <ScrollView style={commonStyles.container} contentContainerStyle={styles.content}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Gastroenterology References</Text>
