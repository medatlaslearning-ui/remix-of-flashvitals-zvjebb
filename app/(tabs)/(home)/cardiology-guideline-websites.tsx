...
import { getCardiologyGuidelineWebsites } from '@/data/cardiologyReferences';

export default function CardiologyGuidelineWebsitesScreen() {
  const router = useRouter();
  const guidelineWebsites = getCardiologyGuidelineWebsites();
      ...
      <ScrollView style={commonStyles.container} contentContainerStyle={styles.content}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerSubtitle}>
            Official clinical practice guidelines and resources
          </Text>
        </View>
            ...
            >
              <View style={styles.websiteContent}>
                <View style={styles.iconContainer}>
                  <IconSymbol name="link.circle.fill" size={32} color={colors.primary} />
                </View>
