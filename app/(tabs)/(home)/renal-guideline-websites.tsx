...
import { getRenalGuidelineWebsites } from '@/data/renalReferences';

export default function RenalGuidelineWebsitesScreen() {
  const router = useRouter();
  const guidelineWebsites = getRenalGuidelineWebsites();
      ...
      <ScrollView style={commonStyles.container} contentContainerStyle={styles.content}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerSubtitle}>
            Official renal medicine resources
          </Text>
        </View>
