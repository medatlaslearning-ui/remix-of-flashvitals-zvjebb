...
export default function EndocrinologyTopicsScreen() {
  ...
  useEffect(() => {
    console.log('EndocrinologyTopicsScreen rendered, updateTrigger:', updateTrigger);
      ...
      <ScrollView style={commonStyles.container} contentContainerStyle={styles.content}>
        ...
        <View style={styles.section}>
          {ENDOCRINE_TOPICS.map((topic, index) => {
            const stats = getTopicStats('Endocrine', topic.name);
          ...
          <Pressable style={styles.referenceCard}>
            <View style={styles.referenceContent}>
              ...
              <View style={styles.referenceInfo}>
                <Text style={styles.referenceTitle}>Endocrine References</Text>
