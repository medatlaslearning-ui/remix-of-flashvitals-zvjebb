...
const ENDOCRINE_TOPICS = [
  {
    ...
    icon: 'drop.circle',
    description: 'Type 1, Type 2, DKA, HHS, complications'
  },
  {
    name: 'Thyroid Disorders',
    icon: 'circle.hexagongrid',
    description: 'Hyper/hypothyroidism, thyroid nodules, cancer'
  },
  {
    name: 'Adrenal Disorders',
    icon: 'triangle.circle',
    description: 'Cushing, Addison, pheochromocytoma'
  },
  {
    name: 'Pituitary Disorders',
    icon: 'brain',
    description: 'Adenomas, hypopituitarism, diabetes insipidus'
  },
  {
    name: 'Calcium & Bone Metabolism',
    icon: 'figure.walk',
    description: 'Hyper/hypocalcemia, osteoporosis, PTH disorders'
  },
  {
    name: 'Reproductive Endocrinology',
    icon: 'person.2',
    description: 'PCOS, hypogonadism, menstrual disorders'
  },
  {
    name: 'Miscellaneous Endocrine Tumors',
    icon: 'circle.grid.cross',
    description: 'MEN syndromes, carcinoid, neuroendocrine tumors'
  }
];

export default function EndocrineTopicsScreen() {
    ...
    <>
      ...
      <ScrollView style={commonStyles.container} contentContainerStyle={styles.content}>
        ...
        <View style={styles.header}>
          <IconSymbol name="waveform.path.ecg" size={48} color={colors.accent} />
