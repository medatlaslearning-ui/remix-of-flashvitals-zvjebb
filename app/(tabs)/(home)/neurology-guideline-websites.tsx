...
import { getNeurologyGuidelineWebsites } from '@/data/neurologyReferences';

export default function NeurologyGuidelineWebsitesScreen() {
  const router = useRouter();
  const guidelineWebsites = getNeurologyGuidelineWebsites();
