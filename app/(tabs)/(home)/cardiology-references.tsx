...
import { cardiologyReferences, getSubcategories } from '@/data/cardiologyReferences';

export default function CardiologyReferencesScreen() {
  ...
  const subcategories = getSubcategories('Cardiology References');

  return (
    <>
      <Stack.Screen
        options={{
          title: 'Cardiology References',
      ...
      <ScrollView style={commonStyles.container} contentContainerStyle={styles.content}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Cardiology References</Text>
        ...
        {subcategories.map((subcategory, subIndex) => {
          const refs = cardiologyReferences.filter(
            ref => ref.category === 'Cardiology References' && ref.subcategory === subcategory
          );
