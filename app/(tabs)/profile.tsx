...
export default function ProfileScreen() {
  ...
  const toggleTopicBreakdown = () => {
    ...
    console.log('Topic breakdown expanded:', !topicBreakdownExpanded);
  };
      ...
      >
        ...
        {activeTab === 'progress' && (
          <>
            ...
            {/* Collapsible Topic Breakdown Section */}
            <View style={styles.section}>
              <Pressable 
                style={styles.topicBreakdownHeader}
                onPress={toggleTopicBreakdown}
              >
                <View style={styles.topicBreakdownTitleContainer}>
                  <Text style={styles.sectionTitle}>Topic Breakdown</Text>
                  <Text style={styles.topicBreakdownSubtitle}>
                    {topicBreakdown.length} topics across all systems
                  </Text>
                </View>
                <IconSymbol 
                  name={topicBreakdownExpanded ? 'chevron.up' : 'chevron.down'} 
                  size={24} 
                  color={colors.primary} 
                />
              </Pressable>
...
const styles = StyleSheet.create({
  ...
  topicBreakdownTitleContainer: {
    flex: 1,
  },
  topicBreakdownSubtitle: {
    fontSize:Perfect! I can see the Profile page already has a "Topic Breakdown" section that displays all topics. The user wants to make this collapsible to reduce clutter. I'll implement a collapsible/expandable UI for the Topic Breakdown section.
