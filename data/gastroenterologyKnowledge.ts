...
export const gastroenterologyKnowledge: MerckManualEntry[] = [
  // ESOPHAGEAL DISORDERS
  {
    ...
    keywords: ['gerd', 'gastroesophageal reflux disease', 'acid reflux', 'heartburn', 'reflux esophagitis', 'gerd disease'],
...

  {
    ...
    keywords: ['barrett esophagus', 'barrett', 'intestinal metaplasia', 'barrett\'s esophagus'],
    system: 'Gastroenterology',
  ...
  {
    topic: 'Achalasia',
    keywords: ['achalasia', 'esophageal motility disorder', 'aperistalsis', 'les dysfunction'],
    system: 'Gastroenterology',
  ...
  // PEPTIC ULCER DISEASE
  {
    ...
    keywords: ['peptic ulcer disease', 'pud', 'gastric ulcer', 'duodenal ulcer', 'peptic ulcer', 'stomach ulcer'],
    system: 'Gastroenterology',
...

  {
    ...
    keywords: ['helicobacter pylori', 'h pylori', 'h. pylori', 'hp infection', 'pylori'],
    system: 'Gastroenterology',
  ...
  {
    topic: 'Crohn Disease',
    keywords: ['crohn disease', 'crohn\'s disease', 'crohns', 'inflammatory bowel disease', 'ibd', 'regional enteritis'],
    system: 'Gastroenterology',
...

  {
    ...
    keywords: ['ulcerative colitis', 'uc', 'inflammatory bowel disease', 'ibd', 'colitis'],
    system: 'Gastroenterology',
  ...
  {
    topic: 'Cirrhosis',
    keywords: ['cirrhosis', 'liver cirrhosis', 'hepatic cirrhosis', 'end stage liver disease', 'esld'],
    system: 'Gastroenterology',
...

  {
    ...
    keywords: ['hepatic encephalopathy', 'he', 'portal systemic encephalopathy', 'liver encephalopathy'],
    system: 'Gastroenterology',
  ...
  {
    topic: 'Ascites',
    keywords: ['ascites', 'peritoneal fluid', 'abdominal fluid', 'fluid in abdomen'],
    system: 'Gastroenterology',
...

  {
    ...
    keywords: ['spontaneous bacterial peritonitis', 'sbp', 'peritonitis', 'infected ascites'],
    system: 'Gastroenterology',
  ...
  // PANCREATIC DISORDERS
  {
    ...
    keywords: ['acute pancreatitis', 'pancreatitis', 'pancreatic inflammation', 'acute pancreatic inflammation'],
    system: 'Gastroenterology',
...

  {
    ...
    keywords: ['chronic pancreatitis', 'chronic pancreatic inflammation', 'pancreatic insufficiency'],
    system: 'Gastroenterology',
  ...
  // MALABSORPTION
  {
    ...
    keywords: ['celiac disease', 'celiac sprue', 'gluten sensitive enteropathy', 'gluten intolerance', 'celiac'],
    system: 'Gastroenterology',
